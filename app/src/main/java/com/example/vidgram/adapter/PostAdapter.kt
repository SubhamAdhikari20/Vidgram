...
class PostAdapter(
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
        val post = postModelList[position]
        ...
        // Set Username
        holder.username.text = post.postBy ?: "Unknown User"
...
// Check if the URL uses HTTP and change it to HTTPS
        val securePostImageUrl =
            if (postImageUrl.startsWith("http://", ignoreCase = true)) {
...
//        holder.postImage.visibility = android.view.View.VISIBLE
